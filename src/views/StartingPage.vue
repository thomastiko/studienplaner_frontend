<template>
  <div>
    <div class="bg-orange-8 q-pa-sm row items-center" style="min-height: 90vh">
      ...
      <q-img src="../assets/badge-header.svg" fit="fill" :style="badgeStyle" class="q-mb-xl q-mt-xl" />
    </div>
      ...
      <div class="col-12 col-md-8 q-mt-md">
        ...
        <div class="col-12 row q-col-gutter-sm">
          ...
          <div class="col-12 col-md-4 row justify-center">
            ...
            <q-card id="card-hover" flat class="bg-transparent">
              <q-img
                src="../assets/meinungsbroschuere.svg"
                fit="scale-down"
                style="height: 300px"
                id="img-hover"
              >
...
export default {
  ...
  computed: {
    ...
    heading() {
      return !this.q.screen.lt.md ? 'text-h3 text-center text-bold text-white q-mb-lg' : 'text-h4 text-center text-bold text-white q-mb-lg'
    },
    headingMargin() {
      return !this.q.screen.lt.md ? 'col-12 row justify-center q-gutter-md q-pt-xl q-mt-xl' : 'col-12 row justify-center q-gutter-md'
    }
  },
  mounted() {}
}
