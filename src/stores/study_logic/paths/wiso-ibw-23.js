function showPath(study, subject) {
  ...
  } else if ((subject._id >= 15 && subject._id <= 23) || (subject._id >= 25 && subject._id <= 27)) {
    update_array.push({ type: 'text', key: 'paths.wiso_bwl_hs' })
  } else if (subject._id == 24) {
    const item = study.subject_states.find((i) => i._id == '23')

    update_array.push(item)
    

  } else if (subject._id == 28 || subject._id == 29) {
