            ...
            <q-card>
              ...
              <q-card-section class="q-pt-none">
                <div v-for="(course, i) in this.userStore.user.course_entries" :key="i">
                  <q-checkbox :label="course.subject_name" v-model="checkbox" :val="course.subject_name" />
                </div>
              </q-card-section>
            ...
            <template v-for="event in eventsMap[timestamp.date]" :key="event._id || event.id">
              <q-badge align="middle" multi-line :style="{ backgroundColor: event.color }">
                ...
                <q-tooltip>
                  ...
                  <div>
                    <span style="text-decoration: underline">Uhrzeit:</span> {{ formatTime(event.start) }} - {{ formatTime(event.end) }}
                  </div>
                </q-tooltip>
              </q-badge>
            </template>
